...
public class VerticalMovementDown : MonoBehaviour
{
    //This script makes the platform move down.
	...
	public float downValue = 10.0f;			// Edit value for pos2 (Wade)
